...
#             Read datafile directly from github location:                 #                      
#                                                                          #
# https://github.com/phuse-org/phuse-scripts/blob/                         #
# master/data/adam/cdiscpilot01/adsl.xpt                                   #
#                                                                          #
#**************************************************************************#
#
# REVISIONS 
...
# 8-Dec-2016 BJF Use local copy of data file
#
