...
%macro params;
	...
	%if %upcase(&run_location.) = LOCAL %then %do;
		...
		%let saspath = C:\Users\TAYLORAu\Desktop\IBM Analysis Panels\SAS Programs\MedDRA_at_a_Glance;
		%let utilpath = C:\Users\TAYLORAu\Desktop\IBM Analysis Panels\SAS Programs\ZZ_Utilities;

		%global aemedout errout;
		%let outpath = C:\Users\TAYLORAu\Desktop\BLA 125476;
		%let aemedout = &outpath.\MedDRA at a Glance Analysis Panel.xls;	
		%let errout = &outpath.\MedDRA at a Glance Error Summary.xls;

		%let studypath = C:\Users\TAYLORAu\Desktop\BLA 125476\C13007\Data\AE;
		...
		/* MedDRA hierachy */
		%let meddrapath = C:\Users\TAYLORAu\Desktop\BLA 125476\MedDRA;
		...
		%let dmepath = C:\Users\TAYLORAu\Desktop\BLA 125476\MedDRA;
